...
func TestHttpGet(t *testing.T) {
	t.Run("it should valid request and status 200", func(t *testing.T) {
...
func TestHttpPost(t *testing.T) {
	t.Run("it should valid request and correct response", func(t *testing.T) {
		ch := make(chan httpResult)
		clientMock := &ClientMock{}
	...
	t.Run("it should invalid request when readbody", func(t *testing.T) {
		ch := make(chan httpResult)
		clientMock := &ClientMock{}
